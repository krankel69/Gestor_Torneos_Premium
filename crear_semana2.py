...
equipos_code = """from fastapi import APIRouter, HTTPException, status
...
with open("src/api_rest/routes/equipos.py", "w") as f:
    f.write(equipos_code)

print("OK - equipos.py ARREGLADO")

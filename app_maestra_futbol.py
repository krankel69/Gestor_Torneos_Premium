...
class AppMaestra(tk.Frame):
    ...
    def _ui_grupos(self, parent):
        ...
        tb.Button(frm_der, text="🔄 Refrescar", bootstyle="info-outline", command=self._cargar_grupo_seleccionado).grid(row=11, column=0, columnspan=3, sticky="ew", pady=3)
        tb.Button(frm_der, text="🖨 Generar Acta PDF", bootstyle="warning-outline", command=self._on_generar_acta_pdf_mundial).grid(row=12, column=0, columnspan=3, sticky="ew", pady=3)
        # Goleadores globales
